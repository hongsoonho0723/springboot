...
public class FreeBoardController {
    ...
    private final static int PAGE_COUNT=5; //한페이지당 5개
    private final static int BLOCK_COUNT=4; // 페이가 한번에 보이는 숫자 1~4 5~8
    ...
    public String insert(FreeBoard freeBoard){
        ...
        FreeBoard saveBoard = freeBoardService.insert(freeBoard);
    ...
    public String read(@PathVariable String bno, Model model,String flag){
        ...
        FreeBoard board = freeBoardService.selectBy(Long.parseLong(bno),state); // 조회수
    ...
    public ModelAndView updateForm(String bno,Model model){
        ...
        FreeBoard board = freeBoardService.selectBy(Long.parseLong(bno),false);// 조회수 증가안되게 false
